...
$KerberosDelegationArray | Sort-Object DelegationType | Select-Object DistinguishedName, DelegationType, Name, ServicePrincipalName | Format-List

Write-Output ""
Write-Output "$Domain Domain Accounts with Kerberos Delegation:"
$KerberosDelegationArray | Sort-Object DelegationType | Select-Object DistinguishedName, DelegationType, Name, ServicePrincipalName | Format-Table -AutoSize
Write-Output ""